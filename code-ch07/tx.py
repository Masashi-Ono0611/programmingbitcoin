...
class Tx:
    ...
    def sig_hash(self, input_index):
        ...
        for i, tx_in in enumerate(self.tx_ins):
            ...
            # construct a temporary TxIn with the desired ScriptSig
            tmp_in = TxIn(
    ...
    def verify_input(self, input_index):
        ...
        # grab the previous ScriptPubKey (locking script)
        script_pubkey = tx_in.script_pubkey(self.testnet)

        # get the signature hash (z) for this input
        z = self.sig_hash(input_index)

        # combine the current ScriptSig (unlocking script) and the previous ScriptPubKey
        combined_script = tx_in.script_sig + script_pubkey

        # evaluate the combined script with z
    ...
    def sign_input(self, input_index, private_key):
        ...
        # calculate the sec (serialized public key)
